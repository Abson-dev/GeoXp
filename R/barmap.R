...
pointfunc<-function() {
    ...
    while(!quit)
    {
        ...
        # graphiques
         ...
         carte(long=long, lat=lat,buble=buble,cbuble=z,criteria=criteria,nointer=nointer,obs=obs, lablong=lablong, lablat=lablat, label=label, symbol=symbol,carte=carte,nocart=nocart,method="Cluster",classe=var,col=color,legmap=legmap,legends=legends,labmod=labmod,axis=axis)
         graphique(var1=var, obs=obs, num=3,graph="Barplot", labvar=labvar, symbol=symbol,labmod=labmod,col=color);
...
if (length(polyX)>0)
{
    ...
    #graphiques
        carte(long=long, lat=lat,buble=buble,cbuble=z,criteria=criteria,nointer=nointer,obs=obs, lablong=lablong, lablat=lablat, label=label, symbol=symbol,col=color,carte=carte,nocart=nocart,method="Cluster",classe=var,legmap=legmap,legends=legends,labmod=labmod,axis=axis)
        graphique(var1=var, obs=obs, num=3,graph="Barplot", labvar=labvar, symbol=symbol,labmod=labmod,col=color);
        if ((graphChoice != "") && (varChoice1 != "") && (length(dev.list()) > 2))
        {
            graphique(var1=listvar[,which(listnomvar == varChoice1)], var2=listvar[,which(listnomvar == varChoice2)], obs=obs, num=4, graph=graphChoice, symbol=1, labvar=c(varChoice1,varChoice2));
...
barfunc<-function()
{
    ...
    while(!quit)
    {
        ...
        # graphiques
        graphique(var1=var, obs=obs, num=3,graph="Barplot", labvar=labvar, symbol=symbol,labmod=labmod,col=color);
        carte(long=long, lat=lat,buble=buble,cbuble=z,criteria=criteria,nointer=nointer,obs=obs, lablong=lablong, lablat=lablat, label=label, symbol=symbol,carte=carte,nocart=nocart,col=color,method="Cluster",classe=var,legmap=legmap,legends=legends,labmod=labmod,axis=axis)
        if ((graphChoice != "") && (varChoice1 != "") && (length(dev.list()) > 2))
        {
            graphique(var1=listvar[,which(listnomvar == varChoice1)], var2=listvar[,which(listnomvar == varChoice2)], obs=obs, num=4, graph=graphChoice, symbol=1, labvar=c(varChoice1,varChoice2));
        }
...
carte(long=long, lat=lat,buble=buble,cbuble=z,criteria=criteria,nointer=nointer,obs=obs, lablong=lablong, lablat=lablat, label=label, symbol=symbol,carte=carte,nocart=nocart,col=color,method="Cluster",classe=var,legends=legends,labmod=labmod,axis=axis)
graphique(var1=var, obs=obs, num=3, graph="Barplot", labvar=labvar, symbol=symbol,labmod=labmod,col=color);
