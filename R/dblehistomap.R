...
####################################################
    ...
    pointfunc <- function() {
     ...
     graphique(var1 = var1, obs = obs, num = 3, graph = "Histogram",nbcol = nbcol1, labvar = labvar[1], symbol = symbol)
     graphique(var1 = var2, obs = obs, num = 4, graph = "Histogram",nbcol = nbcol2, labvar = labvar[2], symbol = symbol)
...
####################################################
    ...
    bar1func <- function() {
        ...
        while (!quit) {
            ...
            obs <<- selectstat(var1 = var1, obs = obs, Xpoly = loc[1],Ypoly = loc[2], method = "Histogram", nbcol = nbcol1)
...
####################################################
    ...
    bar2func <- function() {
        ...
        while (!quit) {
            ...
            obs <<- selectstat(var1 = var2, obs = obs, Xpoly = loc[1],Ypoly = loc[2], method = "Histogram", nbcol = nbcol2)
...
tkfocus(tt1)
    ...
    {
        tkmessageBox(message="Variables (listvar) or variables names (listnomvar) have not been given",icon="warning",type="ok");
    }
  }
